...
docker docker build --build-arg BASE_IMAGE=nvidia/cuda --build-arg TAG=12.3.2-devel-ubuntu22.04 --build-arg PKG_FILE=packages.cuda.txt -t jianshao/cuda-builder:$cuda_ver .
